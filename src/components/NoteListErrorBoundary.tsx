...
const NoteListErrorDisplay: React.FC<NoteListErrorDisplayProps> = ({
  onRetry,
}) => (
...
const NoteListErrorBoundary: React.FC<NoteListErrorBoundaryProps> = ({
  children,
}) => {
  return (
    <ErrorBoundary
      fallback={
        <NoteListErrorDisplay onRetry={() => window.location.reload()} />
      }
    >
      {children}
    </ErrorBoundary>
