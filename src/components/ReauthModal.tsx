...
const ReauthModal: React.FC<ReauthModalProps> = React.memo(
  ({ isOpen, onReconnect, onLogout, onClose }) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2
            id='reauth-title'
            className='text-2xl font-black uppercase font-mono tracking-wider text-off-black dark:text-off-white pr-8'
          >
            SESSION EXPIRED
          </h2>
          <p className='text-base text-off-black/80 dark:text-off-white/80 mt-4 mb-8'>
            Your connection to Google Drive has expired. Please reconnect to
            continue using the application.
          </p>
          <div className='flex items-center gap-x-4'>
            <Button onClick={onReconnect} variant='fill'>
              Reconnect
            </Button>
