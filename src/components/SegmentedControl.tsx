      ...
      {options.map((option, index) => {
        ...
        return (
          <button
            ...
            className={`flex-1 px-3 sm:px-4 py-2 min-h-min-touch-target font-mono text-xs sm:text-sm uppercase tracking-widest cursor-pointer transition-colors duration-normal focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent-black dark:focus-visible:ring-off-white focus-visible:ring-offset-off-white dark:focus-visible:ring-offset-off-black ${
