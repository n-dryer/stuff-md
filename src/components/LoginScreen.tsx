      ...
      <div className='min-h-screen flex flex-col items-center justify-center text-center p-4 bg-off-white dark:bg-off-black'>
        ...
        {error && (
          <div className='mt-6 p-4 border-2 border-destructive-red max-w-md w-full'>
            <h3 className='font-bold font-mono uppercase text-destructive-red'>
              ...
              error.message.includes('Missing required env') && (
                <div className='mt-3 text-xs text-off-black/70 dark:text-off-white/70'>
                  ...
                  <ol className='list-decimal list-inside space-y-1 ml-2'>
                    <li>
                      Copy{' '}
                      <code className='bg-light-gray dark:bg-gray-800 px-1 rounded'>
                        .env.example
                      </code>{' '}
                      to{' '}
                      <code className='bg-light-gray dark:bg-gray-800 px-1 rounded'>
                    ...
                    <li>
                      ...
                      <a
                        ...
                        className='underline text-accent-black dark:text-accent-white'
                      >
                        Firebase Console
                      </a>
                    </li>
