            ...
            {totalCount > 0 && (
              <div className='flex items-center gap-[clamp(0.5rem,1.5vw,0.75rem)]'>
                <button
                  ...
                  disabled={isDeleting}
                  aria-disabled={isDeleting}
                  className='uppercase font-mono font-bold text-xs sm:text-sm md:text-base tracking-wider text-destructive-red hover:text-accent-black dark:text-destructive-red/90 dark:hover:text-off-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent-black dark:focus-visible:ring-off-white focus-visible:ring-offset-off-white dark:focus-visible:ring-offset-off-black min-h-[44px] px-3 sm:px-4 md:px-6 py-2 whitespace-nowrap w-full sm:w-auto border-2 border-destructive-red bg-off-white dark:bg-brutal-gray hover:border-5 dark:border-destructive-red/90 dark:hover:border-destructive-red disabled:opacity-60 disabled:cursor-not-allowed'
                >
                  Delete All
                </button>
                {isDeleting && <BrutalistSpinner />}
